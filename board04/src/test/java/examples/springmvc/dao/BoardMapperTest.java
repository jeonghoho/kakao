...
public class BoardMapperTest {
    ...
    @Test
    public void getBoards2() throws Exception{
        SearchCondition searchCondition = new SearchCondition();
        searchCondition.setCount(5);
        searchCondition.setOffset(5);
        searchCondition.setKind("name");
        searchCondition.setValue("토토");
        List<Board> boards = boardMapper.getBoards(searchCondition);
    ...
    public void addBoard() throws Exception{
        ...
        Long id = boardMapper.addBoard(board);
    ...
    public void getBoardCount() throws Exception{
        ...
        searchCondition.setCount(5);
        searchCondition.setOffset(5);
        int boardCount = boardMapper.getBoardCount(searchCondition);
